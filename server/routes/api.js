//initialize Module we need 
const express = require('express');
const objectChoice = require('../models/objectChoice');
const router = express.Router();
const User = require('../models/user')
const mongoose = require('mongoose')
const db = 'mongodb://photographe-setting:hammouda55@ds247410.mlab.com:47410/photographe-setting'
...
//Methode Post for login User
router.post('/login', (req, res) => {
    let userData = req.body
    User.findOne({ email: userData.email }, (error, user) => { //find the email user if it's the same thing into the database 
...
//Methode Delete for deleting User account
...
//Methode Put for Modification User account
...
//Methode Post for adding a camera setting
...
//Methode Post for updating a camera setting
...
////Methode Delete for deleting a camera setting
...
//Methode Get to Sort camera by place
...
//Methode Get to Sort camera by brand
